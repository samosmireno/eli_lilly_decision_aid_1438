...
const qualityOfLifeData = {
  ...
  ribociclib: {
    ...
    footer:
      "NATALEE Trial Design: Phase III, randomized, open-label trial of 6,101 patients with HR+/HER2− early breast cancer (stages II–III); randomization to ribociclib 400 mg daily (3 wk on / 1 wk off) for 3 years + NSAI vs NSAI alone. Primary endpoint: invasive disease-free survival (iDFS). Median follow-up 44 months. Results: No new safety signals with extended follow-up; most AEs manageable with monitoring and dose adjustment (Fasching PA et al., JAMA Oncol. 2025; e253700). 1. Slamon DJ et al. N Engl J Med. 2024; 390:1080–1091 (NATALEE primary report). 2. Novartis Pharmaceuticals Canada Inc. KISQALI (ribociclib) Product Monograph – Including Patient Medication Information. Montreal (QC); 2025 Jun 12. Submission Control No. 283993. 3. ClinicalTrials.gov NCT03701334. 4. Loibl S et al. Ann Oncol. 2024. 5. Crown J, et al. ESMO Open. 2025;10(1):105858.",
  },
};
