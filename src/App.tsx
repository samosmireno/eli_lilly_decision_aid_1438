...
import { MedicationSideEffects } from "./pages/medication-side-effects";
import { MedicationQualityOfLife } from "./pages/medication-quality-of-life";
import { MedicationCareJourney } from "./pages/medication-care-journey";
